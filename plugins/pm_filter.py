...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton("⭐️ Owner ⭐️", url="https://t.me/NAZZY_FF"), 
            InlineKeyboardButton("📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 📢", url="https://t.me/nazzymovies1")
            ],[      
        ...
        buttons = [[
            InlineKeyboardButton('SOURCE CODE', url='https://github.com/AbHiN45/Eva-POOJA')
            ],[
        ...
        R1 = await query.message.reply_photo(
                 photo="https://telegra.ph/file/b1c258d9cb9cda3b791f6.jpg",
